...
namespace Depra.Common.Unity.Runtime.Extensions.Colors
{
    /// <summary>
    ...
    {
        public static HSV ToHsv(this Color color) => HSV.FromColor(color);

        public static HSL ToHsl(this Color color) => HSL.FromColor(color);
